    ...
    <div class="container"><br>
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-8 center-block" style="float: none;">
                ...
                <div class="panel panel-warning">
                    ...
                    <?php } elseif ($step == 3) { ?>
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                                    <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过网猫支付</div>
                ...
                <footer class="footer">
                    <pre><center>Powered by <a href="#">网猫</a> !</center></pre>
                </footer>
            </div>
        </div>
    </div>
