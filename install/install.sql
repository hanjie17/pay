...
INSERT INTO `pre_config` VALUES ('sitename', '网猫支付');
INSERT INTO `pre_config` VALUES ('title', '网猫支付 - 行业领先的免签约支付平台');
INSERT INTO `pre_config` VALUES ('keywords', '网猫支付,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付');
INSERT INTO `pre_config` VALUES ('description', '网猫支付是网猫IOT旗下的免签约支付产品，完美解决支付难题，一站式接入支付宝，微信，财付通，QQ钱包,微信wap，帮助开发者快速集成到自己相应产品，效率高，见效快，费率低！');
INSERT INTO `pre_config` VALUES ('orgname', '网猫IOT');
INSERT INTO `pre_config` VALUES ('kfqq', '411957428');
...
INSERT INTO `pre_config` VALUES ('transfer_name', '网猫支付');
INSERT INTO `pre_config` VALUES ('transfer_desc', '网猫支付自动结算');
